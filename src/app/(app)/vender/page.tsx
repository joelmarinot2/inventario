...
import { cargarProductos, cargarRanking } from "@/lib/productos-cliente";
...
type Vista = "productos" | "config" | "resumen" | "guardada";
...
export default function VenderPage() {
  ...
  useRefrescar(() => {
    ...
    cargarRanking().then(setRanking).catch(() => {});
  });
  ...
  if (vista === "config" && actual) {
    const props = {
      ...
      onCancelar: () => {
        setActual(null);
        setVista(carrito.length > 0 ? "resumen" : "productos");
      },
    };
